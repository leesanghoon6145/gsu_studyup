...
class StudyTimelines {
  ...
  static final Map<String, List<Map<String, String>>> normalPeriod = {
    'Monday': [
      ...
      {'time': '07:00 ~ 08:00', 'task': '아침 사회.세계사.역사 보기'},
    ...
    'Tuesday': [
      ...
      {'time': '07:00 ~ 08:00', 'task': '아침 사회.세계사.역사 보기'},
      {'time': '16:00 ~ 17:00', 'task': '휴식'},
      {'time': '17:00 ~ 17:50', 'task': '영어(RC) 집중 학습 (50분)'},
      {'time': '17:50 ~ 18:00', 'task': '휴식 (10분)'},
      {'time': '18:00 ~ 19:00', 'task': '저녁식사 및 휴식 (60분)'},
      {'time': '19:00 ~ 19:50', 'task': '수학(이3) 집중 학습 (50분)'},
      {'time': '19:50 ~ 20:00', 'task': '휴식 (10분)'},
      {'time': '20:00 ~ 20:50', 'task': '국어 집중 학습 (50분)'},
      {'time': '20:50 ~ 21:00', 'task': '휴식 (10분)'},
      {'time': '21:00 ~ 21:50', 'task': '과학 집중 학습 (50분)'},
      {'time': '21:50 ~ 22:00', 'task': '휴식 (10분)'},
      {'time': '22:00 ~ 22:50', 'task': '수학(A급) 집중 학습 (50분)'},
      {'time': '22:50 ~ 23:00', 'task': '휴식 취침준비'},
      {'time': '23:00 ~ 06:00', 'task': '취침'},
    ],
    'Wednesday': [
      ...
      {'time': '07:00 ~ 08:00', 'task': '아침 사회.세계사.역사 보기'},
      {'time': '16:00 ~ 17:00', 'task': '휴식'},
      {'time': '17:00 ~ 17:50', 'task': '영어(GR) 집중 학습 (50분)'},
      {'time': '17:50 ~ 18:00', 'task': '휴식 (10분)'},
      {'time': '18:00 ~ 19:00', 'task': '저녁식사 및 휴식 (60분)'},
      {'time': '19:00 ~ 19:50', 'task': '수학(이2-2) 집중 학습 (50분)'},
      {'time': '19:50 ~ 20:00', 'task': '휴식 (10분)'},
      {'time': '20:00 ~ 20:50', 'task': '영어(L/C) 집중 학습 (50분)'},
      {'time': '20:50 ~ 21:00', 'task': '휴식 (10분)'},
      {'time': '21:00 ~ 21:50', 'task': '고등수학 집중 학습 (50분)'},
      {'time': '21:50 ~ 22:00', 'task': '휴식 (10분)'},
      {'time': '22:00 ~ 22:50', 'task': '수학(최블) 집중 학습 (50분)'},
      {'time': '22:50 ~ 23:00', 'task': '휴식 취침준비'},
    ...
    'Thursday': [
      ...
      {'time': '17:50 ~ 18:00', 'task': '휴식 (10분)'},
      {'time': '18:00 ~ 19:00', 'task': '저녁식사 및 휴식 (60분)'},
      {'time': '19:00 ~ 19:50', 'task': '수학(A급) 집중 학습 (50분)'},
      {'time': '19:50 ~ 20:00', 'task': '휴식 (10분)'},
      {'time': '20:00 ~ 20:50', 'task': '국어 집중 학습 (50분)'},
      {'time': '20:50 ~ 21:00', 'task': '휴식 (10분)'},
      {'time': '21:00 ~ 21:50', 'task': '과학 집중 학습 (50분)'},
    ...
    'Friday': [
      ...
      {'time': '07:00 ~ 08:00', 'task': '아침 사회.세계사.역사 보기'},
      {'time': '16:00 ~ 17:00', 'task': '휴식'},
      {'time': '17:00 ~ 17:50', 'task': '영어(GM) 집중 학습 (50분)'},
      {'time': '17:50 ~ 18:00', 'task': '휴식 (10분)'},
      {'time': '18:00 ~ 19:00', 'task': '저녁식사 및 휴식 (60분)'},
      {'time': '19:00 ~ 19:50', 'task': '수학(이3) 집중 학습 (50분)'},
      {'time': '19:50 ~ 20:00', 'task': '휴식 (10분)'},
    ...
    'Saturday': [
      ...
      {'time': '08:00 ~ 09:00', 'task': '사회 (60분)'},
      {'time': '09:00 ~ 09:20', 'task': '휴식 (20분)'},
      {'time': '09:20 ~ 10:20', 'task': '영어(RC) (60분)'},
      {'time': '10:20 ~ 10:40', 'task': '휴식 (20분)'},
      {'time': '10:40 ~ 11:40', 'task': '수학(A급) (60분)'},
      {'time': '11:40 ~ 13:00', 'task': '점심 및 휴식 (80분)'},
      {'time': '13:00 ~ 14:00', 'task': '국어 (60분)'},
      {'time': '14:00 ~ 14:20', 'task': '휴식 (20분)'},
      {'time': '14:20 ~ 15:20', 'task': '과학 (60분)'},
      {'time': '15:20 ~ 15:40', 'task': '휴식 (20분)'},
      {'time': '15:40 ~ 16:40', 'task': '수학(이유2) (60분)'},
      {'time': '16:40 ~ 17:00', 'task': '휴식 (20분)'},
      {'time': '17:00 ~ 17:50', 'task': '국어 학습단원 평가 (50분)'},
      {'time': '17:50 ~ 19:00', 'task': '저녁식사 및 휴식 (60분)'},
      {'time': '19:00 ~ 20:00', 'task': '부족 과목 보충 1 (60분)'},
      {'time': '20:00 ~ 20:20', 'task': '휴식 (20분)'},
      {'time': '20:20 ~ 21:20', 'task': '부족 과목 보충 2 (60분)'},
      {'time': '21:20 ~ 21:40', 'task': '휴식 (20분)'},
      {'time': '21:40 ~ 22:40', 'task': '기술·가정 / 한문 암기 및 평가'},
      {'time': '22:40 ~ 23:00', 'task': '휴식 및 취침준비'},
      {'time': '23:00 ~ 07:00', 'task': '취침'},
    ],
    'Sunday': [
      {'time': '07:00 ~ 08:00', 'task': '기상 + 가벼운 운동 / 아침식사'},
      {'time': '08:00 ~ 09:00', 'task': '사회 진도 총정리 (60분)'},
      {'time': '09:00 ~ 09:20', 'task': '휴식 (20분)'},
      {'time': '09:20 ~ 10:20', 'task': '영어 (GM) (60분)'},
      {'time': '10:20 ~ 10:40', 'task': '휴식 (20분)'},
      {'time': '10:40 ~ 11:30', 'task': '수학 (최블) (50분)'},
      {'time': '11:30 ~ 11:50', 'task': '휴식 (20분)'},
      {'time': '11:50 ~ 13:00', 'task': '점심 및 휴식 (70분)'},
      {'time': '13:00 ~ 14:00', 'task': '국어 (60분)'},
      {'time': '14:00 ~ 14:20', 'task': '휴식 (20분)'},
      {'time': '14:20 ~ 15:10', 'task': '고등수학 (50분)'},
      {'time': '15:10 ~ 16:00', 'task': '수학 (이유3) (50분)'},
      {'time': '16:00 ~ 16:20', 'task': '휴식 (20분)'},
      {'time': '16:20 ~ 17:10', 'task': '국어 학습단원 평가 (50분)'},
      {'time': '17:10 ~ 18:10', 'task': '저녁식사 및 휴식 (60분)'},
      {'time': '18:10 ~ 19:00', 'task': '영어 학습단원 평가 (50분)'},
      {'time': '19:00 ~ 19:20', 'task': '휴식 (20분)'},
      {'time': '19:20 ~ 20:10', 'task': '수학 전체평가 (50분)'},
      {'time': '20:10 ~ 20:30', 'task': '휴식 (20분)'},
      {'time': '20:30 ~ 21:20', 'task': '기술·가정 / 한문 암기 + 학습단원 평가 (50분)'},
      {'time': '21:20 ~ 22:00', 'task': '휴식 및 취침 준비 (40분)'},
      {'time': '22:00 ~ 06:00', 'task': '취침'},
    ]
  };
  ...
  static final List<Map<String, String>> vacationPomodoro1 = [
    ...
    {'time': '22:25 ~ 22:55', 'task': '긴 휴식'},
    {'time': '22:55 ~ 23:20', 'task': '마무리 & 취침 준비'},
    {'time': '23:20 ~ 23:25', 'task': '휴식'},
    {'time': '23:25 ~ 23:50', 'task': '정리'},
    {'time': '23:50 ~ 24:00', 'task': '취침 준비'},
  ];
  ...
  static final List<Map<String, String>> vacationPomodoro2 = [
    ...
    {'time': '17:40 ~ 19:10', 'task': '저녁식사'},
    {'time': '19:10 ~ 19:50', 'task': '집중 영어'},
    {'time': '19:50 ~ 20:00', 'task': '휴식'},
    {'time': '20:00 ~ 20:40', 'task': '집중 국어'},
    {'time': '20:40 ~ 20:50', 'task': '휴식'},
    {'time': '20:50 ~ 21:30', 'task': '집중 과학'},
    {'time': '21:30 ~ 21:40', 'task': '휴식'},
    {'time': '21:40 ~ 22:20', 'task': '집중 사회.세계사'},
    {'time': '22:20 ~ 22:30', 'task': '휴식 및 취침준비'},
  ];
